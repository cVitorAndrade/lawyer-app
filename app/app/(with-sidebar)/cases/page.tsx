            ...
            <MetricCard.Header>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    className='bg-zinc-700/50 text-xs font-semibold py-1.5 rounded-[9999px] outline-none hover:bg-zinc-700/50 h-fit'
                  >
                    Last 7 days
      ...
      <div className='flex items-center justify-between gap-4 border-b py-4'>
        <div className='flex flex-col gap-1'>
          ...
          <p className='text-sm text-neutral-600'>
            Keep track of the cases you are involved in. Find detailed information and updates on each process in a practical and organized way
          </p>
        </div>
